...
function gitUrlParse(url, refs) {
    ...
    // Store the full repository path (before owner/name split) for users who need it
    // This addresses cases where users want the full path like "group/subgroup/repo"
    // instead of just "repo" for the name field
    urlInfo.repo_path = urlInfo.name;
